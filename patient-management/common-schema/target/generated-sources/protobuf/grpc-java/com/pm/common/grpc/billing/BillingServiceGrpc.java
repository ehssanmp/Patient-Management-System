...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.pm.common.grpc.billing.BillingRequest,
      com.pm.common.grpc.billing.BillingResponse> getCreateBillingAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBillingAccount",
      requestType = com.pm.common.grpc.billing.BillingRequest.class,
      responseType = com.pm.common.grpc.billing.BillingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.pm.common.grpc.billing.BillingRequest,
      com.pm.common.grpc.billing.BillingResponse> getCreateBillingAccountMethod() {
    io.grpc.MethodDescriptor<com.pm.common.grpc.billing.BillingRequest, com.pm.common.grpc.billing.BillingResponse> getCreateBillingAccountMethod;
      ...
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillingAccountMethod = BillingServiceGrpc.getCreateBillingAccountMethod) == null) {
          BillingServiceGrpc.getCreateBillingAccountMethod = getCreateBillingAccountMethod =
              io.grpc.MethodDescriptor.<com.pm.common.grpc.billing.BillingRequest, com.pm.common.grpc.billing.BillingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBillingAccount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.common.grpc.billing.BillingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.pm.common.grpc.billing.BillingResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createBillingAccount(com.pm.common.grpc.billing.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.common.grpc.billing.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceStub
    ...
    /**
     */
    public void createBillingAccount(com.pm.common.grpc.billing.BillingRequest request,
        io.grpc.stub.StreamObserver<com.pm.common.grpc.billing.BillingResponse> responseObserver) {
  ...
  public static final class BillingServiceBlockingStub
    ...
    /**
     */
    public com.pm.common.grpc.billing.BillingResponse createBillingAccount(com.pm.common.grpc.billing.BillingRequest request) {
  ...
  public static final class BillingServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.pm.common.grpc.billing.BillingResponse> createBillingAccount(
        com.pm.common.grpc.billing.BillingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILLING_ACCOUNT:
          serviceImpl.createBillingAccount((com.pm.common.grpc.billing.BillingRequest) request,
              (io.grpc.stub.StreamObserver<com.pm.common.grpc.billing.BillingResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.pm.common.grpc.billing.BillingRequest,
              com.pm.common.grpc.billing.BillingResponse>(
  ...
  private static abstract class BillingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.pm.common.grpc.billing.Billing.getDescriptor();
    }
